...
import { useToggleTutorial } from '@/hooks/useOnboarding';
...
export default function Sidebar() {
    ...
    const handleReopenGuide = () => toggleTutorial.mutate(true);
            ...
            <div className="border-t border-[var(--border)] p-3">
                ...
                {!collapsed && (
                    <button
                        ...
                        title="Réouvrir le guide de l'app"
                        className="mt-2 w-full flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs text-[var(--text-muted)] hover:bg-[var(--surface-hover)] hover:text-[var(--primary)] transition-colors"
                    >
                        <span>📋</span>
                        <span>Guide de l'app</span>
                    </button>
                )}
            </div>
